...
const SideBar = ({ active, setIsSidebarOpen , isSidebarOpen , toggleSidebar }) => {
  ...
  return (
    <div className={`w-[75%] md:w-[16.66%] px-6 min-h-screen border-r fixed top-0 left-0 transition-transform transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} z-50 md:translate-x-0 bg-white`}>
